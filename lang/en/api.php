...
return [
    ...
    'match_schedule_request' => [
        ...
        'already_assigned_or_unavailable' => 'Another stadium already accepted this match, or the request is no longer available.',
        'stadium_open_title' => 'New match request in your area',
        'stadium_open_body' => 'A paired match schedule request #:id is waiting for a stadium. Open stadium match requests to accept with a pitch.',
