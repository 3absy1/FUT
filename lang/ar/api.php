...
return [
    ...
    'auth' => [
        ...
        'password_reset_otp_sent' => 'تم إرسال رمز OTP. يرجى التحقق لإعادة تعيين كلمة المرور (استخدم 1111 للاختبار).',
    ...
    'match_schedule_request' => [
        ...
        'already_assigned_or_unavailable' => 'ملعب آخر قبل هذه المباراة بالفعل، أو أن الطلب لم يعد متاحًا.',
        'stadium_open_title' => 'طلب مباراة جديد في منطقتك',
        'stadium_open_body' => 'طلب جدولة مباراة مكتمل (الخصم محدد) رقم #:id بانتظار ملعب. افتح طلبات الملعب لقبوله واختيار الملعب.',
    ...
    'match_result' => [
        ...
        'clubs_must_be_same_area' => 'يجب أن يكون الناديان في نفس المنطقة للعب هذه المباراة.',
        'stadium_area_mismatch' => 'يجب أن تتطابق منطقة الملعب مع منطقة الناديين.',
    ],
];
